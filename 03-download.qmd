...
The button can be used to download almost anything. By default (if nothing is specified thtough the dowload handler, it download the source file

that needs to be handled by a download handler
